...
void StartLCDTask(void *argument);  // Use this for LCD Task

/* USER CODE BEGIN PFP */
void MX_FREERTOS_Init(void) {
  /* Create the defaultTask (optionally keep or remove if not needed) */
...
{
  // LCD code is in freertos.c
  extern void LCD_TaskBody(void *argument);
  LCD_TaskBody(argument);
}
